<%@ Page Title="" Language="C#" MasterPageFile="~/Aspx/MasterPage.master" AutoEventWireup="true" CodeFile="FileUpload.aspx.cs" Inherits="Aspx_FileUpload" %>
...
<br />
 ...
 <br />
    ...
    <ItemTemplate>
        <asp:LinkButton ID="LinkButtonDelete" runat="server" CommandName="Delete" CausesValidation="false" OnClientClick='return confirm("Are You Sure?")'>Delete</asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField>
